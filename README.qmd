...
[![OSF DOI](https://img.shields.io/badge/DOI-10.17605/OSF.IO/S4TBZ.svg)](https://doi.org/10.17605/OSF.IO/S4TBZ)
...
This repository contains the [Quarto book](https://quarto.org/docs/books/) of my Master's Thesis: *Associations between the duration and quality of sleep of pregnant women in the third trimester with the duration of labor*. The research compendium is accessible via [The Open Science Framework](https://osf.io/) by clicking [here](https://doi.org/10.17605/OSF.IO/S4TBZ).
