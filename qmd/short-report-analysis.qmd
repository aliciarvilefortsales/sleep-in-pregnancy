...
## Get Descriptive Statistics of the Time Interval of Data Collection

```{r}
#| label: Get Descriptive Statistics of the Time Interval of Data Collection
#| code-fold: false
...
test <-
  data |>
  select(\(x) test_temporal(x, rm = c("Date", "POSIXct"))) |>
  tbl_summary(
